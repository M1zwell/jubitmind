...
|----------|----------|-------|
| **macOS** | [JubitMind.dmg](https://github.com/M1zwell/jubitmind/releases/download/v0.79.0/JubitMind-0.79.0-arm64.dmg) | Apple Silicon (arm64) |
| **Windows** | [JubitMind-Setup.exe](https://github.com/M1zwell/jubitmind/releases/download/v0.79.0/JubitMind.Setup.0.79.0.exe) | NSIS installer |
